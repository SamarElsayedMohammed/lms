...
Route::middleware([PanelAuthenticate::class])->group(function (): void {
    /** Dashboard Routes */
    ...
    Route::put('/subscription-plans/{subscriptionPlan}/country-prices', [SubscriptionPlanController::class, 'updateCountryPrices'])->name('subscription-plans.country-prices');
