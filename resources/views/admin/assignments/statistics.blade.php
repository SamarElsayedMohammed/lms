    ...
    <div class="section-body">
                        ...
                        <div class="col-md-1 col-sm-6 d-flex justify-content-end">
                            <div class="d-flex w-100 gap-2 flex-wrap">
                                <button type="submit" class="btn btn-primary flex-fill">
                                    <i class="fas fa-search mr-2"></i>{{ __('Apply') }}
                                </button>
                                <a href="{{ route('admin.assignments.statistics') }}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted">{{ __('Overall Acceptance Rate') }}</p>
                                </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>{{ __('Submissions by Course') }}</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ? round(($course->count / $statistics['overview']['total_submissions']) *
                                            100, 2)
                                            : 0;
                                            @endphp
                                            {{ $percentage }}%
