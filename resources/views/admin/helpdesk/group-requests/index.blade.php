                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-3">
                            <div class="card bg-primary text-white">
                                <div class="card-body">
                                    <h5 class="card-title">{{ __('Total Requests') }}</h5>
                    ...
                    <div class="table-responsive">
                        <table id="group-requests-table" class="table table-striped"
                            data-url="{{ route('admin.helpdesk.group-requests.index') }}" data-pagination="true"
                            ...
                            data-maintain-selected="true" data-export-data-type="all" data-export-options='{"fileName": "group-requests-<?=
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="operate" data-sortable="false"
                                        data-formatter="actionColumnFormatter" data-events="groupRequestAction"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="update-status-btn">{{ __('Update Status') }}</button>
            </div>
        </div>
    </div>
</div>
