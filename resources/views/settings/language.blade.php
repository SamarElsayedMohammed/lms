...
@section('main')
    <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin stretch-card search-container">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{-- Form start --}}
                        <form action="{{ route('language.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate class="create-form"> @csrf <div class="row">
        <div class="col-sm-12 col-md-6 form-group mandatory">
            <label for="name" class="form-label">{{ __('Language Name') }}</label>
            <input type="text" name="name" id="name" class="form-control" placeholder="{{ __('Language Name') }}" data-parsley-required="true">
        </div>

        <div class="col-sm-12 col-md-6 form-group mandatory">
            <label for="name_in_english" class="form-label">{{ __('Language Name') }} ({{ __('in English') }})</label>
            <input type="text" name="name_in_english" id="name_in_english" class="form-control" placeholder="{{ __('Language Name') }} ({{ __('in English') }})" data-parsley-required="true">
        </div>

        <div class="col-sm-12 col-md-6 form-group mandatory">
            <label for="code" class="form-label">{{ __('Language Code') }}</label>
            <input type="text" name="code" id="code" class="form-control" placeholder="{{ __('Language Code') }}" data-parsley-required="true">
        </div>
        ...
        <div class="col-sm-12 col-md-6 form-group mandatory">
            ...
            <input type="text" name="country_code" id="country_code" class="form-control" placeholder="{{ __('Country Code') }}" data-parsley-required="true">
        </div>
        ...
        <div class="col-sm-12 col-md-6 form-group mandatory">
            ...
            <input class="form-control" type="file" name="image" id="favicon_icon" accept=".jpg,.jpeg,.png">
        </div>
         ...
         <div class="col-sm-1 col-md-6">
            <div class="custom-switches-stacked mt-2">
                ...
                <label class="custom-switch">
                    ...
                    <input type="checkbox" name="rtl" value="1" id="rtl" class="custom-switch-input">
            ...
            <div class="col-md-12 grid-margin stretch-card search-container">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{-- Note: Languages table doesn't support soft deletes, so no Trashed tab --}}
                        <table class="table-light table-striped" aria-describedby="mydesc" id="table_list"
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" data-field="is_default" data-sortable="true" data-formatter="defaultFormatter">{{ __('Default') }}</th>
                                        ...
                                        <th scope="col" data-field="operate" data-escape="false" data-formatter="operateFormatter" data-sortable="false" data-events="languageEvents">{{ __('Action') }}</th>
...
@section('script')
<script>
    // Formatter for default language column
    ...
    // Formatter for operate column to ensure HTML is not escaped
        ...
        function validateJsonFile(input, fieldName) {
            ...
            if (!allowedExtensions.test(fileName)) {
                ...
                if (typeof Swal !== 'undefined') {
                    ...
                    Toast.fire({
                        icon: 'error',
                        title: 'Only JSON files are allowed for ' + fieldName.replace('_', ' ')
                    });
                }
                return false;
            }
                ...
                reader.onload = function(e) {
                    try {
                        ...
                        if (typeof Swal !== 'undefined') {
                            ...
                            Toast.fire({
                                icon: 'error',
                                title: 'Invalid JSON file format'
                            });
                        }
                    }
                };
