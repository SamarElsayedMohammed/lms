    ...
    <div id="dashboard-content" style="display: none;">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                <x-stat-card icon="fas fa-users" color="primary" :title="__('Total Users')" title-id="total-users-label"
                    value-id="total-users-count" growth-id="total-users-growth" :growth-label="__('from last month')" />
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                <x-stat-card icon="fas fa-graduation-cap" color="success" :title="__('Total Courses')"
                    title-id="total-courses-label" value-id="total-courses-count" growth-id="total-courses-growth"
                    :growth-label="__('from last month')" />
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                <x-stat-card icon="fas fa-rupee-sign" color="warning" :title="__('Total Earnings')"
                    title-id="total-earnings-label" value-id="total-earnings-count" growth-id="total-earnings-growth"
                    :growth-label="__('from last month')" />
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                <x-stat-card icon="fas fa-chalkboard-teacher" color="info" :title="__('Total Instructors')"
                    title-id="total-instructors-label" value-id="total-instructors-count" />
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                <x-stat-card icon="fas fa-play-circle" color="success" :title="__('Active Courses')"
                    title-id="active-courses-label" value-id="active-courses-count" />
            </div>

            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                <x-stat-card icon="fas fa-tags" color="secondary" :title="__('Total Categories')"
                    title-id="total-categories-label" value-id="total-categories-count" />
            </div>
        </div>
...
<script>
    ...
    function updateStatCard(prefix, data) {
        if (data) {
            ...
            // Translated label is preserved from the blade file
