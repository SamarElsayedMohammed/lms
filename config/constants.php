...
return [
    ...
    'DEFAULT_SETTINGS' => [
        ...
        ['name' => 'firebase_api_key', 'value' => '', 'type' => 'string'],
        ['name' => 'firebase_auth_domain', 'value' => '', 'type' => 'string'],
        ['name' => 'firebase_storage_bucket', 'value' => '', 'type' => 'string'],
        ['name' => 'firebase_messaging_sender_id', 'value' => '', 'type' => 'string'],
        ['name' => 'firebase_app_id', 'value' => '', 'type' => 'string'],
        ['name' => 'firebase_measurement_id', 'value' => '', 'type' => 'string'],
